  ...
  return (
    ...
    <div className="grid grid-cols-2 grid-rows-2 md:grid-rows-1 md:grid-cols-4 place-content-center items-center my-2">
      <div className="flex gap-2">
        ...
        <div>
          <button
            className="flex py-2 pl-1.5 pr-3 rounded-md bg-gray-50 border border-gray-300 items-center gap-1.5 text-xs font-medium text-gray-900 transition-all duration-500 hover:bg-gray-200"
            onClick={() => setCurrentNepaliDate(new NepaliDate())}
          >
            <EventIcon />
            Today
